...
fun main() {
    ...
    // max id of lines, skip first and last rows
    var allPossiblePasses = (128..((128*8)-128)).toSet()
    val allPasses = lines.map{ getBoardingPassID(it) }.toSet()

    val outstanding = allPossiblePasses - allPasses
    println("Found outstanding seat: $outstanding")
}
